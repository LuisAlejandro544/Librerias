...
`;
  ...
  fs.writeFileSync(path.join(publicDir, "stridb-install.sh"), installerScript, "utf-8");
  console.log("✅ Estático 'public/stridb-install.sh' generado correctamente.");
} catch (error) {
  console.error("❌ Error al generar 'public/stridb-install.sh':", error);
  process.exit(1);
}
